...
At what surge height do the branches merge (the dike always fails)?
Also: notice how few samples appear in the high-damage tail of the histogram.
What does this tell you about the efficiency of naive Monte Carlo for estimating tail risk?*
:::
...
Use the damage distribution in @fig-stochastic to support your answer.*
:::
...
Which one would you trust more for a policy decision, and why?*
:::
...
*How did increasing the shape parameter (fatter tails) affect the EAD?
...
*How much did 0.5m of sea-level rise increase the EAD?
Is the increase proportional to the SLR amount?
What does this tell you about the relationship between sea-level rise and flood risk?*
:::
...
See the [ICOW parameter documentation](https://dossgollin-lab.github.io/ICOW.jl/equations.html#parameters) for the full list of parameters you can change — try adjusting others beyond the four listed here.
...
What features of your city's geometry (elevation, coastline length, seawall height) explain the difference?*
:::
...
Each question references a specific section above — scroll up to review the context if needed.
